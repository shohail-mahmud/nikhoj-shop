  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold mb-8">About Your Shop name</h1>
        <div className="max-w-3xl mx-auto space-y-6 text-lg">
          <p>Your Shop name started as a vision to blend creativity, fashion, and individuality. Each piece is inspired by art that's hidden but never lost — a story expressed through color and fabric.</p>
